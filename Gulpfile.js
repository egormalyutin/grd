...
var BUILDERS, BUILDFILES, BUILDFILES_DIR, BuildFiles, CONFIG_NAME, TEST, Vinyl, addGameConfig, ar, beep, bf, cache, concat, debug, decompress, del, e, error, exists, filter, fs, generateGameConfig, gif, gulp, ico, ignore, ignorify, imagemin, log, merge, moon, moonify, noop, path, plumber, rcedit, rename, tap, tarxz, through, watch, zip;
...
// MIX TASKS
gulp.task('build', gulp.series(gulp.parallel('get:buildfiles', 'clean:dist', 'clean:build'), 'start:dist', gulp.parallel('build:love', 'build:icon'), 'build:main', 'build:copy-icon', 'build:rcedit', TEST ? 'test' : 'noop'));
