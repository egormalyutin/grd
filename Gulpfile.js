...
var BUILDERS, BUILDFILES, BUILDFILES_DIR, BuildFiles, CONFIG_NAME, TEST, Vinyl, addGameConfig, ar, beep, bf, cache, concat, debug, decompress, del, e, error, exists, filter, fs, generateGameConfig, gif, gulp, ico, ignore, ignorify, imagemin, merge, moon, moonify, noop, path, plumber, rcedit, rename, tap, tarxz, through, watch, zip;
